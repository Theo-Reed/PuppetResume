...
1. **职责描述 (Responsibilities)**：
   ...
   - **长度精准控制**：每条职责描述的视觉字数点数（中文字符计1点，英数/标点计0.5点）必须精准控制在 **${Math.floor((context.maxCharPerLine || 50) * 0.92)} 到 ${Math.floor((context.maxCharPerLine || 50) * 0.98)}** 点之间。
   - **重要性排序**：必须按重要性从高到低排列。
...
3. **技能列表 (Skills)**：
   ...
   - **高度要求**：每条技能点的视觉点数必须在 **38 到 48** 点之间（旨在双列排版下呈现为 2 行，且第二行填充率超过 50%）。
...
\`\`\`json
{
  ...
  "professionalSkills": [
    { "title": "分类1", "items": ["技能1 (38-48点)", "技能2 (38-48点)", "技能3 (38-48点)", "技能4 (38-48点)"] },
    { "title": "分类2", "items": ["技能1 (38-48点)", "技能2 (38-48点)", "技能3 (38-48点)", "技能4 (38-48点)"] },
    { "title": "分类3", "items": ["技能1 (38-48点)", "技能2 (38-48点)", "技能3 (38-48点)", "技能4 (38-48点)"] },
    { "title": "分类4", "items": ["技能1 (38-48点)", "技能2 (38-48点)", "技能3 (38-48点)", "技能4 (38-48点)"] }
  ],
  "workExperience": [
    {
      "company": "...",
